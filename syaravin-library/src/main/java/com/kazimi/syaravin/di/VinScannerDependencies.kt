...
import com.kazimi.syaravin.data.datasource.ml.LiteRtRuntime
...
import com.kazimi.syaravin.presentation.scanner.ScannerViewModelStrings
...
internal object VinScannerDependencies {
    ...
    internal class DependencyContainer(
         ...
         * Targets [ScannerPerfConfig.imageAnalysisWidth]×[imageAnalysisHeight] (or the device's
         * highest available resolution when [ScannerPerfConfig.imageAnalysisPreferHighestRes] is
         * set). PREFER_HIGHER_RESOLUTION lifts CameraX's default ~1080p analysis cap, and the
         * round-up fallback keeps the bound stream at or above the target instead of below it.
            ...
            val resolutionSelector =
                ResolutionSelector
                    ...
                    .setAllowedResolutionMode(
                        ...
                        if (ScannerPerfConfig.imageAnalysisPreferHighestRes) {
